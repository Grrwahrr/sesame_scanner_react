...
const Notification = ({type, message, description, txid, onHide}) => {
    ...
    return (
        <div
            className={"max-w-sm w-full bg-neutral text-neutral-content shadow-lg rounded-md mt-2 pointer-events-auto ring-1 ring-black ring-opacity-5 p-2 mb-12 overflow-hidden"}
        >
            <div className={`p-4`}>
